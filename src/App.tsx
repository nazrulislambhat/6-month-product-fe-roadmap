...
const roadmap = [
  ...
  },
  {
    ...
    milestone:
      'Can migrate any JS React codebase to TypeScript. Can architect state management without overthinking.',
  },
  {
    month: 4,
    label: 'Jun 8 – Jul 8',
    ...
    project: {
      name: 'Streaming Platform UI (Engineering-focused)',
      stack: 'React + TS + TanStack Query + Vitest + MSW + Cypress',
    ...
    milestone:
      'Can profile any React app, identify bottlenecks, fix them, and prove it with metrics. 80%+ test coverage.',
  },
  {
    month: 5,
    label: 'Jul 8 – Aug 8',
    ...
    topics: [
      ...
      {
        name: 'Real-time: WebSockets vs SSE vs long polling vs WebRTC',
        type: 'system',
      },
      {
  ...
  },
  {
    ...
    project: {
      ...
      desc: 'Not a template. A custom-designed Next.js site: page transitions with Framer Motion, interactive project showcases with live demos embedded, a technical blog with MDX where you document your 7-month journey (this alone gets you referrals), dark/light theme, Lighthouse 95+ score.',
...
const safeSet = async (key: string, val: string): Promise<boolean> => {
  try {
...
export default function Roadmap() {
  ...
  useEffect(() => {
    (async () => {
      const [prog, theme] = await Promise.all([
        safeGet(STORAGE_KEY),
        safeGet(THEME_KEY),
      ]);
      if (prog) {
        try {
          setChecked(JSON.parse(prog));
        } catch {}
      }
  ...
  return (
    ...
    >
            ...
            <div>
              ...
              <div
                style={{
                  fontSize: 20,
                  fontWeight: 800,
                  background: `linear-gradient(90deg,${dark ? '#fff' : '#1a1a2e'} 0%,${m.color} 100%)`,
            ...
            >
              <div style={{ display: 'flex', gap: 10, alignItems: 'center' }}>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: 7 }}>
                  ...
                  <span style={{ fontSize: 10, color: m.color, minWidth: 30 }}>
                    {pct}%
                  </span>
                </div>
                {/* Dark/light toggle */}
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
                <span style={{ fontSize: 9, color: T.muted2 }}>
                  {done}/{total} topics · ~21.5h/week · ~630h total
                </span>
              </div>
            </div>
          </div>
      ...
      <div style={{ maxWidth: 980, margin: '0 auto', padding: '20px 24px' }}>
        ...
        <div
          style={{
            background: `linear-gradient(135deg,${m.color}0d 0%,${T.bg3} 70%)`,
        ...
        {tab === 'topics' && (
          <>
            ...
            >
              {[
                ['Weekdays 2–3h', m.weekdays, T.border],
                ...
                >
                  ...
                  <div
                    style={{ fontSize: 11, color: T.text3, lineHeight: 1.7 }}
                  >
                    {val}
                  </div>
                </div>
          ...
          >
            ...
            >
              ...
              >
                ...
                <div style={{ fontSize: 12, color: T.text4, lineHeight: 1.8 }}>
                  {m.project.why}
                </div>
              </div>
            </div>
